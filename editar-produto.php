...
<?php 
    ...
    if (isset($_POST['editar'])){
      #Objeto do tipo produto com os campos do form
      $produto = new Produto((int) $_POST['id'], $_POST['tipo'], $_POST['nome'], $_POST['descricao'], (float) str_replace(['R$ ', '.', ','], ['', '', '.'], $_POST['preco']));
...
<main>
  <section class="container-admin-banner">
    <img src="img/logo-Blackout-horizontal.png" class="logo-admin" alt="logo-Blackout">
  ...
  <section class="container-form">
    <form method="post" enctype="multipart/form-data">
      ...
      <input type="text" id="preco" name="preco" value="<?= $produto->getPreco() ?>" placeholder="Digite uma descrição" required>
